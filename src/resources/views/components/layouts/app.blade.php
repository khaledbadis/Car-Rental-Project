...
@foreach(['dashboard'=>['home',null],'vehicles'=>['truck','fleet.view'],'customers'=>['user-group','customers.view'],'reservations'=>['calendar-days','reservations.view'],'rentals'=>['key','rentals.view'],'availability'=>['calendar-date-range','reservations.view'],'preferences'=>['adjustments-horizontal',null],'staff'=>['users','staff.manage'],'settings'=>['cog-6-tooth','settings.manage'],'audit'=>['clock','audit.view']] as $page=>[$icon,$permission])
